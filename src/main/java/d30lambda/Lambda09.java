...
//        System.out.println(donusList);
    ...
    public static void bestenCokAz(List<String> myList){
        myList.
                stream().
                distinct().
                filter(t->t.length()<5).
    ...
    public static void alfabetikTekrarsiz(List<String> myList){
        myList.
                stream().
                distinct().
                sorted().
    ...
    //reversed() metodu t ile olan durumda çalışmıyor.
