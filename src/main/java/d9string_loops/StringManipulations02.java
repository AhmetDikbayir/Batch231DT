...
public class StringManipulations02 {
    public static void main(String[] args) {
        ...
        //indexOf("u") ==> 1   farklı yani tekrarlı
        //lastIndexOf("u") ==> 3

        //indexOf("y") ==> 0    aynı yani tekrarsız
        //lastIndexOf("y") ==> 0
        ...
        int lastIndex = cardNum.lastIndexOf(" ");
        String first = cardNum.substring(0,lastIndex).replaceAll("[0-9]", "*");
        System.out.println(first);

        String last = cardNum.substring(lastIndex);
