...
public class Arrays01 {
    ...
    */
        ...
        for(int i =0; i<cities.length; i++){
            //length fielddır. Alan okuması yapar. Köşeli parantez içini okur.
            totalChar +=cities[i].length(); // length() metotdur. Aktif sayma yapar.
        }
        ...
        //variable ismi olarak da genel kabul w'nun kullanilmasidir. (whatever in kısaltmasıdır.)
